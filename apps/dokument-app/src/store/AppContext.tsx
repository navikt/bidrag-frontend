import { BidragCommonsProvider, SecuritySessionUtils } from "@navikt/bidrag-ui-common";
...
import { useHentPerson2 } from "../servicesV2/usePersonApi";
...
export const AppProvider = ({ children }: { children: ReactNode }) => {
    ...
    return (
        <BidragCommonsProvider useHentPersonData={useHentPerson2}>
