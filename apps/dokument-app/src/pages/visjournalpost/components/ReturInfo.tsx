...
import type { Matcher } from "@navikt/ds-react/esm/date/utils";
    ...
    return (
        <div style={{ paddingTop: "15px" }}>
            ...
            <ReturDetaljerSummary
                returDetaljer={journalpost.returDetaljer}
            ...
            {journalpost.returDetaljer.logg && journalpost.returDetaljer.logg.length > 0 && (
                <div className={"retur-detaljer-logg"} style={{ paddingTop: "24px" }}>
                    ...
                    {journalpost.returDetaljer.logg
                        ...
                        .sort(sortByDate)
                        .map((logg, index) => (
                            <ReturDetaljerLog logg={logg} index={index} journalpost={journalpost} />
                        ))}
                </div>
            )}
        </div>
