...
export class HttpClient<SecurityDataType = unknown> {
    ...
    constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
        this.instance = axios.create({
            ...axiosConfig,
            baseURL: axiosConfig.baseURL || "https://bidrag-organisasjon.dev.intern.nav.no/bidrag-organisasjon",
        });
        this.secure = secure;
        this.format = format;
 ...
 * @version v1
 * @baseUrl https://bidrag-organisasjon.dev.intern.nav.no/bidrag-organisasjon
 */
