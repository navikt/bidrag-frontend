...
export default [
    ...
    route("sak/ny", "./routes/sak/saksroller/opprett-ny-sak/routes/NySaksrollerPage.tsx"),
    route("sak/ny/saksroller", "./routes/sak/saksroller/opprett-ny-sak/routes/NySakLegacyRedirect.ts"),
