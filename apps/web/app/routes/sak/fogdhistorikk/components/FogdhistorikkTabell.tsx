                ...
                <Table.Body>
                    {historikk.map((h) => (
                        <Table.Row key={h.tilgangId}>
                            <Table.DataCell className={"cell"}>{h.enhetsnummer}</Table.DataCell>
                            <Table.DataCell>
                                <EnhetsNavn enhetsnummer={h.enhetsnummer} />
                            </Table.DataCell>
                            <Table.DataCell className={"cell"}>{h.arsakBeskrivelse}</Table.DataCell>
                            <Table.DataCell className={"cell"}>{h.opprettetAv}</Table.DataCell>
                            <Table.DataCell className={"cell"}>{formaterDato(h.tilgangFomDato)}</Table.DataCell>
                            <Table.DataCell className={"cell"}>
                                {h.tilgangTomDato ? formaterDato(h.tilgangTomDato) : ""}
                            </Table.DataCell>
                        </Table.Row>
                    ))}
                </Table.Body>
