import { type EditDocumentBroadcastMessage, LoggerService } from "@navikt/bidrag-ui-common";
import { Alert, BodyShort, Checkbox, CheckboxGroup, Heading, Label } from "@navikt/ds-react";
...
import type { Dokument, Journalpost } from "../../../../../types/journalpost";
...
import { type AvvikTypeCommonProps, getFagomradeLabel } from "./AvvikTypes";
