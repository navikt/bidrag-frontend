...
import { dokumenterToString } from "../../../../../types/journalpost";
import { dokumentToString } from "../../../../../types/journalpost";
...
function SendTilFagomradeSecondStep(props: SendTilFagomradeSecondStepProps) {
    ...
    function openBisysPrintoppgave() {
        const dokumenter = props.relevanteDokumenter
            ...
            .join("+");
        window.open(
            `${environment.url.bisys}OppgavePopup.do?state=opprett&vedlegg=${dokumenter}&saksnr=${saksnummer}&beskrivelse=Vennligst+skriv+ut+og+send+de+vedlagte+dokumentene.+Takk!&mappe=Print`
        );
    }
