...
import {LagreJournalpostRequest, RegistrerJournalpostRequest} from "../types/api/JournalpostTypes";
import {HTTPStatus} from "../types/enum/HttpStatus";
import {Journalpost, JournalpostMapper} from "../types/journalpost";
import {HentAvvikEnum, IdentType, JournalpostDto, JournalpostResponse} from "@bidrag/api/BidragDokumentApi";
