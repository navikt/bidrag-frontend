...
import { QueryKeys, useUpdateForpleining } from "../../common/hooks/useApiData";

export const useOnSaveForpleining = (underholdsid: number) => {
    const queryClient = useQueryClient();
    const { behandlingId } = useBehandlingProvider();
    const mutation = useUpdateForpleining(underholdsid);
