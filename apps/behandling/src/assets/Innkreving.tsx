export default function InnkrevingIkon() {
    return (
        <div title="Med innkreving">
            <svg xmlns="http://www.w3.org/2000/svg" height="12" width="12" viewBox="0 0 512 512" role="img">
                <title>Med innkreving</title>
