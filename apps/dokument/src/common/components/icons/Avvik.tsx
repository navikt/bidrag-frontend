    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="110" height="110" scale="0.3">
            ...
            <g fill="none" fillRule="evenodd">
                <path fill="transparent" d="M-287-1518H993V543H-287z" />
                <rect width="796" height="181" fill="transparent" rx="8" transform="translate(-45 -36)" />
                <circle cx="55" cy="55" r="55" fill="#CCDEE6" />
                <g fill="#D8D8D8">
                    <path
                        fill="#337C9B"
                    ...
                    />
                    <path fill="#38363A" d="M38.322 51.833l1.77-.474-12.12-45.233-1.77.474z" />
                    <path fill="#CE2128" d="M26.593 57.996l-1.179-.613-.713 1.12-.93-3.47 1.892-.507z" />
                </g>
                <path
                    fill="#FFF"
                ...
                <path fill="#E1CFB4" d="M86.458 79.011l-1.334 7.43 6.268-4.21-2.12-2.355z" />
                <path fill="#FECB86" d="M103.266 56.87l-1.644-1.073-14.841 22.72 1.643 1.072z" />
                <path fill="#FAA736" d="M104.912 57.945l-1.644-1.074-14.841 22.72 1.644 1.073z" />
                <path
                    fill="#FECB86"
