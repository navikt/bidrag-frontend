...
import {PartialAlertProps, TilgangLocalAlert} from "./TilgangLocalAlert.tsx";
...
export function tilgangssjekkResultat(
    ...
    return {
        harTilgang: false,
        TilgangAlert: (props: PartialAlertProps) => <TilgangLocalAlert title={manglendeTilgangTittel}
                                                                       tilgangResultat={data} {...props}/>,
    };
}
